...
PATH="$PWD/.ci/sd4/bs/bin:$PATH" opam pin add --yes --no-action ocaml.4.12.1 "git://github.com/diskuv/dkml-compiler.git#${TEMP_OCAML:-main}"
PATH="$PWD/.ci/sd4/bs/bin:$PATH" opam pin add --yes --no-action ocaml-config.2 "git://github.com/diskuv/dkml-compiler.git#${TEMP_OCAML_CONFIG:-main}"
PATH="$PWD/.ci/sd4/bs/bin:$PATH" opam pin add --yes --no-action dkml-option-32bit "git://github.com/diskuv/dkml-compiler.git#${DKML_OPTION_32BIT:-main}"
